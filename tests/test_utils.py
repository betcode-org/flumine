...
class UtilsTest(unittest.TestCase):
    ...
    def test_calculate_matched_exposure(self):
        self.assertEqual(utils.calculate_matched_exposure([], []), (0., 0.))
        self.assertEqual(utils.calculate_matched_exposure([(0, 0)], [(0, 0), (0, 0)]), (0., 0.))
        self.assertEqual(utils.calculate_matched_exposure([(5.6, 2)], []), (9.2, -2.))
        self.assertEqual(utils.calculate_matched_exposure([], [(5.6, 2)]), (-9.2, 2.))
        self.assertEqual(utils.calculate_matched_exposure([], [(5.6, 2), (5.8, 2)]), (-18.8, 4.))
        self.assertEqual(utils.calculate_matched_exposure([(5.6, 2)], [(5.6, 2)]), (0., 0.))
        self.assertEqual(
            utils.calculate_matched_exposure([(5.6, 2), (100, 20)], [(5.6, 2)]), (1980., -20.)
        )
        self.assertEqual(
            utils.calculate_matched_exposure([(5.6, 2), (100, 20)], [(10, 1000)]), (-7010.80, 978.)
        )
        self.assertEqual(utils.calculate_matched_exposure([(10, 2)], [(5, 2)]), (10., 0.))
        self.assertEqual(utils.calculate_matched_exposure([(10, 2)], [(5, 4)]), (2., 2.))
        self.assertEqual(utils.calculate_matched_exposure([(10, 2)], [(5, 8)]), (-14., 6.))

        self.assertEqual(utils.calculate_matched_exposure([(5.6, 200)], [(5.6, 100)]), (460., -100.))

    def test_calculate_unmatched_exposure(self):
        self.assertEqual(utils.calculate_unmatched_exposure([], []), (0., 0.))
        self.assertEqual(utils.calculate_unmatched_exposure([(0, 0)], [(0, 0), (0, 0)]), (0., 0.))
        self.assertEqual(utils.calculate_unmatched_exposure([(5.6, 2.)], []), (0., -2.))
        self.assertEqual(utils.calculate_unmatched_exposure([], [(5.6, 2)]), (-9.2, 0.))
        self.assertEqual(utils.calculate_unmatched_exposure([], [(5.6, 2), (5.8, 2)]), (-18.8, 0.))
        self.assertEqual(utils.calculate_unmatched_exposure([(5.6, 2)], [(5.6, 2)]), (-9.2, -2.))
        self.assertEqual(
            utils.calculate_unmatched_exposure([(5.6, 2), (100, 20)], [(5.6, 2)]), (-9.2, -22.)
        )
        self.assertEqual(
            utils.calculate_unmatched_exposure([(5.6, 2.), (100., 20.)], [(10, 1000)]), (-9000., -22.)
        )
        self.assertEqual(utils.calculate_unmatched_exposure([(10., 2.)], [(5, 2)]), (-8., -2.))
        self.assertEqual(utils.calculate_unmatched_exposure([(10, 2)], [(5, 4)]), (-16., -2.))
        self.assertEqual(utils.calculate_unmatched_exposure([(10, 2)], [(5, 8)]), (-32., -2.))

        self.assertEqual(utils.calculate_unmatched_exposure([(5.6, 200.)], [(5.6, 100)]), (-460., -200.))
