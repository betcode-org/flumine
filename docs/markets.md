...
For example backtesting uses [simulated middleware](https://github.com/betcode-org/flumine/blob/master/flumine/markets/middleware.py#L15) in order to calculate order matching.
